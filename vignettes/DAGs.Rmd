...
data <- generateTumorData(tumor,snps.seq=0,snps.ary=NA,mu=0,sigma.reads=10,sigma0.lrr=.15, sigma0.baf=.03,density.sigma=.1)
```
...
somaticDataSet <- lapply(1:length(tumors),function(i){
  tumorDataSet <- generateTumorData(tumors[[i]],snps.seq=0,snps.ary=NA,mu=0,sigma.reads=10,sigma0.lrr=.15,
...
```{r, echo=FALSE, fig.width=8, fig.height=6}
plot(somaticDataSet[[1]]$VAF,xlab='Mutation Index',ylab='VAF',pch=16)
plot(somaticDataSet[[2]]$VAF,xlab='Mutation Index',ylab='VAF',pch=16)
plot(somaticDataSet[[3]]$VAF,xlab='Mutation Index',ylab='VAF',pch=16)
plot(somaticDataSet[[4]]$VAF,xlab='Mutation Index',ylab='VAF',pch=16)
plot(somaticDataSet[[5]]$VAF,xlab='Mutation Index',ylab='VAF',pch=16)
```